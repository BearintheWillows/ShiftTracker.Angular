    ...
    public partial class IdentityTableCreation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RunVariant", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RunVariant_Run_RunId",
                        column: x => x.RunId,
                        principalTable: "Run",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayOfWeek = table.Column<int>(type: "int", nullable: false),
                    WindowOpenTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryPoint_RunVariant_RunVariantId",
                        column: x => x.RunVariantId,
                        principalTable: "RunVariant",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeliveryPoint_Shop_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shop",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryPoint_RunVariantId",
                table: "DeliveryPoint",
                column: "RunVariantId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliveryPoint_ShopId",
                table: "DeliveryPoint",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_RunVariant_RunId",
                table: "RunVariant",
                column: "RunId");
